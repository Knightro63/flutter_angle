...
@objc public class FlutterAnglePlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "getIOSurfaceHandle":
            ...
            #if !targetEnvironment(simulator)
            self.renders[textureId]!.getIOSurfaceHandle(textureId: textureId, result: result)
            #endif
        ...
        case "textureFrameAvailable":
            ...
            #if !targetEnvironment(simulator)
            self.renders[textureId]!.textureFrameAvailable(textureId: textureId, result: result)
            #endif
